...
__2. How pathogen prevalence shifts over time within different habitats?__  
...
```{r}
readRDS("../../results/resulttablePathHab.rds")

readRDS("../../results/resulttablePathSea.rds")

readRDS("../../results/resulttablePathSpe.rds")
```
...
![Figure 3. Decision Tree for Predictors of Total Pathogen](../../results/rparttreeFull.png) 
